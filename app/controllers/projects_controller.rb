class ProjectsController < ApplicationController
  ...
  before_action :set_tenant, only: [:show, :edit,:update, :destroy, :new, :created]
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:title, :details, :started_date, :expected_completion_date, :hours, :tenant_id)
    end
